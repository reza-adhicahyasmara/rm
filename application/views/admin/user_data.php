...
function add_user()
{
   ...
   save_method = 'update';
    ...
    $.ajax({
      ...
      success: function(data)
      {
        ...
        //PENAMBAHAN POLI UNTUK DOKTER - by exitus
        $('[name="id_poli"]').val(data.id_poli);
  ...
  //SHOW HIDE POLI - by exitus
  $(document).ready(function() {
  $("#level").change(function() {
    var level = $(this).val();
     console.log(level) 
    if(level == "6"){
      $("div#form_poli").show(500);
      $('#id_poli').attr('name', 'id_poli');
    }else{
      $("div#form_poli").hide(500);
      $('#id_poli').attr('name', '');
    }
  });
  });
      ...
      <div class="modal-body form">
        <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="card-body">
            ...
            <!-- PENAMBAHAN POLI UNTUK DOKTER - by exitus -->
            <div class="form-group row " id="form_poli" style="display:none">
              <label for="id_poli" class="col-sm-3 col-form-label">Poli</label>
              <div class="col-sm-9 kosong">
                <select class="form-control" name="" id="id_poli">
