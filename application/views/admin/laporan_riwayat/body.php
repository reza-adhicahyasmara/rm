...
<script type="text/javascript">
    var url_laporan_riwayat =  "<?php echo base_url('admin/laporan/riwayat'); ?>";
    var url = url_laporan_riwayat ;
...
<script type="text/javascript">
    ...
    $("#no_remed").change(function() {
        ...
        $.ajax({
            url : '<?php echo base_url('admin/laporan/load_data_laporan_riwayat'); ?>',
            method: 'POST',
