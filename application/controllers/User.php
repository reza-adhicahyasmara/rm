...
class User extends MY_Controller {
    ...
    public function index()
    {
        ...
        //TARIK POLI UNTUK DOKTER - by exitus
        $data['data_poli'] = $this->Mod_user->getAllPoli()->result();
    ...
    public function download()
        {
            ...
            foreach($user as $row)
            {
                $sheet->setCellValue('A'.$rekam_medis, $no++);
                $sheet->setCellValue('B'.$rekam, $row->username);
